...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2 = QLabel(self.sliders_groupbox)
        ...
        sizePolicy7.setHeightForWidth(self.isovalue_display.sizePolicy().hasHeightForWidth())
        self.isovalue_display.setSizePolicy(sizePolicy7)
        self.isovalue_display.setFrameShape(QFrame.StyledPanel)
        self.isovalue_display.setFrameShadow(QFrame.Raised)
        self.isovalue_display.setSmallDecimalPoint(True)
        self.isovalue_display.setDigitCount(6)
        ...
        self.object_angle_slider.setTickPosition(QSlider.TicksBelow)
        self.object_angle_slider.setTickInterval(1)
        ...
        self.junction_object_angle_slider.setTickPosition(QSlider.TicksBelow)
        self.junction_object_angle_slider.setTickInterval(1)

        self.gridLayout_2.addWidget(self.junction_object_angle_slider, 7, 0, 1, 1)

        self.junction_object_angle_display = QLCDNumber(self.sliders_groupbox)
        self.junction_object_angle_display.setObjectName(u"junction_object_angle_display")
        self.junction_object_angle_display.setFrameShape(QFrame.StyledPanel)
        self.junction_object_angle_display.setFrameShadow(QFrame.Plain)
        self.junction_object_angle_display.setSmallDecimalPoint(True)
        self.junction_object_angle_display.setDigitCount(6)
        self.junction_object_angle_display.setSegmentStyle(QLCDNumber.Flat)

        self.gridLayout_2.addWidget(self.junction_object_angle_display, 7, 1, 1, 1)

        self.object_angle_display = QLCDNumber(self.sliders_groupbox)
        self.object_angle_display.setObjectName(u"object_angle_display")
        sizePolicy10 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.MinimumExpanding)
        sizePolicy10.setHorizontalStretch(0)
        sizePolicy10.setVerticalStretch(0)
        sizePolicy10.setHeightForWidth(self.object_angle_display.sizePolicy().hasHeightForWidth())
        self.object_angle_display.setSizePolicy(sizePolicy10)
        self.object_angle_display.setFrameShape(QFrame.StyledPanel)
        self.object_angle_display.setFrameShadow(QFrame.Plain)
        self.object_angle_display.setSmallDecimalPoint(True)
        self.object_angle_display.setDigitCount(6)
        ...
        sizePolicy11.setHeightForWidth(self.isovalue_slider.sizePolicy().hasHeightForWidth())
        self.isovalue_slider.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.isovalue_label.sizePolicy().hasHeightForWidth())
        self.isovalue_label.setSizePolicy(sizePolicy12)
        ...
        self.stroke_width_display.setEnabled(True)
        sizePolicy7.setHeightForWidth(self.stroke_width_display.sizePolicy().hasHeightForWidth())
        self.stroke_width_display.setSizePolicy(sizePolicy7)
        font = QFont()
        font.setBold(False)
        self.stroke_width_display.setFont(font)
        self.stroke_width_display.setFocusPolicy(Qt.StrongFocus)
        self.stroke_width_display.setContextMenuPolicy(Qt.PreventContextMenu)
        self.stroke_width_display.setAutoFillBackground(True)
        ...
        self.stroke_width_display.setProperty(u"value", 2.000000000000000)
        self.stroke_width_display.setProperty(u"intValue", 2)
        ...
        sizePolicy13.setHeightForWidth(self.stroke_width_slider.sizePolicy().hasHeightForWidth())
        self.stroke_width_slider.setSizePolicy(sizePolicy13)
        self.stroke_width_slider.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.stroke_width_slider.setMinimum(1)
        self.stroke_width_slider.setMaximum(76)
        self.stroke_width_slider.setSingleStep(1)
        self.stroke_width_slider.setPageStep(1)
        self.stroke_width_slider.setValue(8)
        self.stroke_width_slider.setSliderPosition(8)
        self.stroke_width_slider.setOrientation(Qt.Horizontal)
        self.stroke_width_slider.setTickPosition(QSlider.TicksBelow)
        self.stroke_width_slider.setTickInterval(4)
        ...
        sizePolicy8.setHeightForWidth(self.stroke_width_label.sizePolicy().hasHeightForWidth())
        self.stroke_width_label.setSizePolicy(sizePolicy8)
        self.stroke_width_label.setLayoutDirection(Qt.LeftToRight)
        ...
        sizePolicy14.setVerticalStretch(8)
        sizePolicy14.setHeightForWidth(self.ImageOptionsBox.sizePolicy().hasHeightForWidth())
        self.ImageOptionsBox.setSizePolicy(sizePolicy14)
        ...
        sizePolicy15.setHeightForWidth(self.ImageTabWidget.sizePolicy().hasHeightForWidth())
        self.ImageTabWidget.setSizePolicy(sizePolicy15)
        self.ImageTabWidget.setTabPosition(QTabWidget.North)
        self.ImageTabWidget.setTabShape(QTabWidget.Rounded)
        self.ImageTabWidget.setElideMode(Qt.ElideLeft)
        ...
        sizePolicy16 = QSizePolicy(QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Expanding)
        sizePolicy16.setHorizontalStretch(0)
        sizePolicy16.setVerticalStretch(0)
        sizePolicy16.setHeightForWidth(self.scrollArea_2.sizePolicy().hasHeightForWidth())
        self.scrollArea_2.setSizePolicy(sizePolicy16)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 292, 134))
        ...
        sizePolicy10.setHeightForWidth(self.original_image_radiobutton.sizePolicy().hasHeightForWidth())
        self.original_image_radiobutton.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.distance_radiobutton.sizePolicy().hasHeightForWidth())
        self.distance_radiobutton.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.clean_canvas_radiobutton.sizePolicy().hasHeightForWidth())
        self.clean_canvas_radiobutton.setSizePolicy(sizePolicy10)
        ...
        sizePolicy15.setHeightForWidth(self.OverlaysTabWidget.sizePolicy().hasHeightForWidth())
        self.OverlaysTabWidget.setSizePolicy(sizePolicy15)
        self.OverlaysTabWidget.setTabShape(QTabWidget.Rounded)
        self.OverlaysTabWidget.setElideMode(Qt.ElideLeft)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 278, 157))
        ...
        sizePolicy10.setHeightForWidth(self.level_set_contour_checkbox.sizePolicy().hasHeightForWidth())
        self.level_set_contour_checkbox.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.junctions_checkbox.sizePolicy().hasHeightForWidth())
        self.junctions_checkbox.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.stroke_graph_checkbox.sizePolicy().hasHeightForWidth())
        self.stroke_graph_checkbox.setSizePolicy(sizePolicy10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Object Angle Threshold (Junctions)", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"Object Angle Threshold (Pruning)", None))
        ...
        self.upsampling_combobox.setItemText(1, QCoreApplication.translate("MainWindow", u"2x Bilinear", None))
        self.upsampling_combobox.setItemText(2, QCoreApplication.translate("MainWindow", u"4x Bilinear", None))
        self.upsampling_combobox.setItemText(3, QCoreApplication.translate("MainWindow", u"2x Naive", None))
        self.upsampling_combobox.setItemText(4, QCoreApplication.translate("MainWindow", u"4x Naive", None))
